...
{
    public class EmployeeSalaryServices : Injectable, IEmployeeSalaryServices
    {
        private readonly IRepository<EmployeeSalary> _salaryRepository;
        private readonly IMapper _mapper;
        private readonly IUnitOfWork _unitOfWork;

        public EmployeeSalaryServices(
        ...
        public Task<PaginatedResult<EmployeeSalaryDto>> GetAllSalariesAsync(int pageNumber = 1, int pageSize = 10, string searchTerm = "", string status = "")
        {
            throw new NotImplementedException();
        }

        public Task<List<EmployeeSalaryDto>> GetSalariesByDepartmentAsync(int departmentId)
        {
            throw new NotImplementedException();
        }
    }
