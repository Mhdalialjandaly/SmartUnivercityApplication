...
{
    public class AcademicCalendarService :Injectable ,IAcademicCalendarService
    {
        private readonly IRepository<AcademicCalendar> _calendarRepository;
        private readonly IUnitOfWork _unitOfWork;
        private readonly IMapper _mapper;

        public AcademicCalendarService(IRepository<AcademicCalendar> calendarRepository, 
            IMapper mapper,
