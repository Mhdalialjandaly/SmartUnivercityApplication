...
{
    public class StudentPaymentServices : Injectable, IStudentPaymentServices
    {
        private readonly IRepository<StudentPayment> _paymentRepository;
        private readonly IMapper _mapper;
        private readonly IUnitOfWork _unitOfWork;

        public StudentPaymentServices(
        ...
        public async Task<List<StudentPaymentDto>> GetPaymentsByStudentAsync(int studentId)
        {
        ...
        public Task<PaginatedResult<StudentPaymentDto>> GetAllPaymentsAsync(int pageNumber = 1, int pageSize = 10, string searchTerm = "", string status = "")
        {
            throw new NotImplementedException();
        }

        public Task<List<StudentPaymentDto>> GetRecentPaymentsAsync(int count = 10)
        {
            throw new NotImplementedException();
        }
    }
