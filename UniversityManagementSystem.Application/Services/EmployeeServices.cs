...
{
    public class EmployeeServices : Injectable, IEmployeeServices
    {
        ...
        public EmployeeServices(IRepository<Employee> repository, IRepository<Department> departmentRepo, IUnitOfWork unitOfWork, IMapper mapper)
        {
