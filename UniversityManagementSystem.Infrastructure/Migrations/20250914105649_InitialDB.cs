    ...
    public partial class InitialDB : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseRevenues", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CourseRevenues_Departments_DepartmentId",
                        column: x => x.DepartmentId,
                        principalTable: "Departments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FinancialReports_Departments_DepartmentId",
                        column: x => x.DepartmentId,
                        principalTable: "Departments",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ScheduledReports_Departments_DepartmentId",
                        column: x => x.DepartmentId,
                        principalTable: "Departments",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EnrollmentPercentage = table.Column<double>(type: "float", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StudentApplications_Students_StudentId1",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StudentPayments_Departments_DepartmentId",
                        column: x => x.DepartmentId,
                        principalTable: "Departments",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                table: "Nationalities",
                columns: new[] { "Id", "CountryCode", "CountryName", "CreatedAt", "DeletedAt", "DeletedBy", "Description", "ModifiedAt", "ModifiedBy" },
                values: new object[,]
                {
                    { 1, "1", "Syria", new DateTime(2025, 7, 24, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null },
                    { 2, "2", "Iraq", new DateTime(2025, 7, 24, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null }
                });

            migrationBuilder.InsertData(
                table: "Tunnels",
                columns: new[] { "Id", "CreatedAt", "DeletedAt", "DeletedBy", "FirstPart", "ModifiedAt", "ModifiedBy", "Name", "SecoundPart", "TypeOfkinship" },
                values: new object[,]
                {
                    { 1, new DateTime(2025, 7, 24, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "-", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "NoTunnel", "-", "-" },
                    { 2, new DateTime(2025, 7, 24, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "-", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "ابن شهيد", "-", "اب" }
                });

            migrationBuilder.InsertData(
                table: "Universities",
                columns: new[] { "Id", "CreatedAt", "DeletedAt", "DeletedBy", "Description", "ModifiedAt", "ModifiedBy", "Name", "Type" },
                values: new object[,]
                {
                    { 1, new DateTime(2025, 7, 24, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "Premier university in UAE", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "UAE University", null },
                    { 2, new DateTime(2025, 7, 24, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "Premier university in SVU", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "SVU University", null }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ArchiveItems_DepartmentId",
                table: "ArchiveItems",
                column: "DepartmentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseRevenues_DepartmentId",
                table: "CourseRevenues",
                column: "DepartmentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeSalaries_DepartmentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FinancialReports_DepartmentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ScheduledReports_DepartmentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentApplications_StudentId1",
                table: "StudentApplications",
                column: "StudentId1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentPayments_DepartmentId",
                table: "StudentPayments",
                column: "DepartmentId");
